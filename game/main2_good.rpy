label good_end:
    ...
    h "Так-так, а от я хотів би пошвидше прийти додому й пограти в ігри"
...
label class:
    ...
    h "Знову уроки"
    "Пробурчав я"
    s "Ну чого ти! Більше ентузіазму в голосі!"
...
label magazone:
    ...
    #---------------------------------------------------------------------------------------------------------------          
            #Сон де Соломія відштовхує героя. Зізнання Соломії, бо у гг не вистачило рішучості. Перший поцілунок
