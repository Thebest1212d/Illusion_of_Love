...
## екран промови, повинен створювати елемент відображення з ідентифікатором
## "what", а також може створювати елементи відображення з ідентифікаторами
## "namebox", "who" та "window".
##
