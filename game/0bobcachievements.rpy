...
define BOBCACHIEVEMENT_LIST = (
    ("first", _("Це початок?"), _("Моя перша любов починається тут?")),
    ("heart", _("Розбите серце"), _("Любов це лише ілюзія?")),
    ("kiss", _("Солодкий поцілунок"), _("Усе буває вперше")),
    ("wedding_ach", _("Партнерка"), _("Вітання молодятам!")),
    ("alone", _("Самотність"), _("Ціна гачі")),
    ("success", _("Успішний успіх"), _("Мрія не завжди ідеальна")),
    ("gacha", _("2-д тянка"), _("Пристрасть до 2-д")),
...
define BOBCACHIEVEMENT_NOTIFY_PREFIX = _("Ви отримали досягнення:")
